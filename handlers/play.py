...
async def play(_, message: Message):
    ...
    res = await message.reply_text("Memprosess...")
    ...
    if audio:
        ...
        if offset in (None,):
            await res.edit_text("lu ngga ngasih apa apaan untuk di play ajg!")
            return
    ...
    if message.chat.id in callsmusic.active_chats:
        ...
        await res.edit_text(f"{#️⃣position} antrian ditambahkan sans!")
    else:
        await res.edit_text("▶️ gass gua play ni...")
